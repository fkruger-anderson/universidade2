...
public class Program {
    public static void main(String[] args) {
        ...
        uni1.buscarCurso(1).buscarTurma(1).matricularAlunoTurma(uni1.buscarAlunoUni("A19931"));
        uni1.buscarCurso(1).buscarTurma(1).matricularAlunoTurma(uni1.buscarAlunoUni("A19932"));
        uni1.buscarCurso(1).buscarTurma(1).matricularAlunoTurma(uni1.buscarAlunoUni("A19933"));
        uni1.buscarCurso(1).buscarTurma(1).matricularAlunoTurma(uni1.buscarAlunoUni("A19934"));
        uni1.buscarCurso(1).buscarTurma(1).matricularAlunoTurma(uni1.buscarAlunoUni("A19935"));

        uni1.buscarCurso(1).criarTurma("Programação II", 30, "P20202");
        
        uni1.buscarCurso(1).buscarTurma(2).matricularAlunoTurma(uni1.buscarAlunoUni("A19931"));
        uni1.buscarCurso(1).buscarTurma(2).matricularAlunoTurma(uni1.buscarAlunoUni("A19932"));
        uni1.buscarCurso(1).buscarTurma(2).matricularAlunoTurma(uni1.buscarAlunoUni("A19933"));
        uni1.buscarCurso(1).buscarTurma(2).matricularAlunoTurma(uni1.buscarAlunoUni("A19934"));
        uni1.buscarCurso(1).buscarTurma(2).matricularAlunoTurma(uni1.buscarAlunoUni("A19935"));
